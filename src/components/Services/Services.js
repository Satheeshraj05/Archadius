...
const SectionContainer = styled.div`
  ...
  &:first-of-type::after {
    ...
    right: 0;
    bottom: 0;
    background-color: rgba(2, 2, 2, 0.9); /* Dark overlay */
...
const ServiceCard = styled.div`
  background-color: rgba(45, 45, 45, 0.8); /* Slightly transparent background */
  padding: 2rem;
  text-align: center;
  width: 15rem;
    ...
    <>
      <SectionContainer>
        <ContentContainer>
          ...
          <ServicesContainer>
            <ServiceCard>
              <ServiceIcon className="fas fa-drafting-compass" />
              <ServiceTitle>Architectural Design</ServiceTitle>
            </ServiceCard>
            <ServiceCard>
              <ServiceIcon className="fas fa-couch" />
              <ServiceTitle>Interior Design</ServiceTitle>
            </ServiceCard>
            <ServiceCard>
              <ServiceIcon className="fas fa-tree" />
